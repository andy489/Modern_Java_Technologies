...
public class CommandExecutor {
    ...
    public static final String TEN_DASH = "----------";
    ...
    public static final int CELLS_GAME_STATUS = 14;
    public static final int BLANKS_AFTER_GAME_PLAYERS = 6;
    public static final int CELLS_PER_DIM = 10;
