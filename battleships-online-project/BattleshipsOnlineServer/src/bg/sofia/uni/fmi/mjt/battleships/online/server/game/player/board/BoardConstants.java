...
public class BoardConstants {
    ...
    public static final int SIMPLE_ATTACK_ARGS_COUNT = 4;
    ...
    public static final String INVALID_PLACEMENT = "There already is a ship placed there or direction is not valid";
    ...
    public static final String INVALID_COORDINATES = "Invalid coordinates. Usage: attack <[A-J]> <[1-10]>";
    ...
    public static final String MSG_DEFENDER_MASSIVE_ATTACK =
            "You were massively attacked and were hit %d time(s) and lost %d ship(s)!";
