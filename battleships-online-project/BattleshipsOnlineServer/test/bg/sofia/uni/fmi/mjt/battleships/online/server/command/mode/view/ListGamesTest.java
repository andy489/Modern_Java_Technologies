...
public class ListGamesTest {
    ...
    public void testAttackNotTwoArguments() {
        ...
        String expected = RED_SEP + " NAME     " + RED_SEP + " CREATOR  " + RED_SEP + " STATUS       " +
                RED_SEP + " PLAYERS  " + RED_SEP + System.lineSeparator() + RED + "> |" + DEFAULT +
                TEN_DASH + "+" + TEN_DASH + "+" + TEN_DASH + "----" + "+" + TEN_DASH + RED_SEP +
                System.lineSeparator() + RED + "> |" + DEFAULT + " " + "my-game" + "  " + RED_SEP + " " +
                "host-name" + RED_SEP + " " + RED + "in" + DEFAULT + " progress  " + RED_SEP + " 2/2      " + RED_SEP;
